            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body" id="yourScore">
                  <input type="hidden" name="session_uid" id="session_uid" value="9690655910">
                  ...
                  <input type="hidden" name="session_start_time" id="session_start_time" value="">
                  <input type="hidden" name="session_end_time" id="session_end_time" value="">
